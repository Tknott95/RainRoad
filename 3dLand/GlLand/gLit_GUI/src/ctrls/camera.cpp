...
void Camera::updateCameraVectors() {
  ...
  transform.Right = normalize(glm::cross(transform.Front, transform.WorldUp));  // Normalize the vectors, because their length gets closer to 0 the more you look up or down which results in slower movement.
